            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="ncasa" class="col-md-4 col-form-label text-md-right">{{ __('N° de casa') }}</label>

                            <div class="col-md-6">
                                <input id="ncasa" type="number" class="form-control" name="ncasa" value="{{ old('ncasa') }}" required autofocus>
                            </div>
                        </div>
